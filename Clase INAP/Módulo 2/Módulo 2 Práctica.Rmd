...
Luego, obtenga el número máximo y, por último, el mínimo del vector ```numeros_impares``` (puede realizar una búsqueda en Internet para aprender cómo se hace).
